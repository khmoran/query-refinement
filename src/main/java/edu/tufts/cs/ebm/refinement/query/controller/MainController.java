...
public class MainController implements Initializable {
  ...
  protected void handleCreateReviewButtonAction( ActionEvent e ) {
    ...
    this.mainStage.setWidth(
        createReviewController.getView().getPrefWidth() + 40 );
    this.mainStage.setHeight(
        createReviewController.getView().getPrefHeight() + 40 );
  ...
  protected void handleMenuConfigureAction( ActionEvent e ) {
    ...
    this.mainStage.setWidth(
        configureReviewController.getView().getPrefWidth() + 40 );
    this.mainStage.setHeight(
        configureReviewController.getView().getPrefHeight() + 40 );
    this.mainStage.centerOnScreen();
    this.mainStage.show();
  }
  ...
  protected void handleMenuDetailsAction( ActionEvent e ) {
    ...
    this.mainStage.setWidth(
        reviewDetailsController.getView().getPrefWidth() + 40 );
    this.mainStage.setHeight(
        reviewDetailsController.getView().getPrefHeight() + 40 );
    this.mainStage.centerOnScreen();
    this.mainStage.show();
  }
