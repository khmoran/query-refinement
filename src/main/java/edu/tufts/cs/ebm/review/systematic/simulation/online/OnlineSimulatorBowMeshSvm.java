 ...
 */
public class OnlineSimulatorBowMeshSvm extends OnlineSimulatorBowMesh {
  /** The Logger for this class. */
  protected static final Log LOG = LogFactory.getLog(
      OnlineSimulatorBowMeshSvm.class );
  /** The instances. */
   ...
   * @throws Exception
   */
  public OnlineSimulatorBowMeshSvm( String review ) throws Exception {
    super( review );
  }
