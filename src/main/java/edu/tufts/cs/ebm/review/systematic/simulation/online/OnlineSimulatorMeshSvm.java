 ...
 * representation for MeSH terms and an SVM classifier.
 */
public class OnlineSimulatorMeshSvm extends OnlineSimulatorMesh {
  /** The Logger for this class. */
  protected static final Log LOG = LogFactory.getLog(
      OnlineSimulatorMeshSvm.class );
  /** The instances. */
   ...
   * @throws Exception
   */
  public OnlineSimulatorMeshSvm( String review ) throws Exception {
    super( review );
  }
